...
function showCertificate(img) {
  // Create a new element to display the certificate
  var certificate = document.createElement('div');
  certificate.classList.add('certificate-popup');
  
  // Create an image element to display the certificate image
  var certificateImg = document.createElement('img');
  certificateImg.src = img.src;
  
  // Add the image to the certificate popup element
  certificate.appendChild(certificateImg);
  
  // Add the certificate popup element to the page
  document.body.appendChild(certificate);
  
  // Add an event listener to the certificate popup element to remove it when clicked
...
// For each close button, attach a click event listener
